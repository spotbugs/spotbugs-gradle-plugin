...
abstract class SpotBugsTextReport @Inject constructor(objects: ObjectFactory, task: SpotBugsTask) :
    ...
    override fun getDisplayName(): String {
        return String.format("Text type report generated by the task %s", task.path)
    }
}
