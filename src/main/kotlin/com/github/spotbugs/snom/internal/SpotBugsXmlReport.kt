...
abstract class SpotBugsXmlReport @Inject constructor(objects: ObjectFactory, task: SpotBugsTask) :
    ...
    override fun getDisplayName(): String {
        return String.format("XML type report generated by the task %s", task.path)
    }
}